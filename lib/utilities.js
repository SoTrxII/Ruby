...
exports.replyRandom = (message) => {
    return new Promise((resolve, reject) => {
        ...
        let finalReplics = (authorCustomResponses) ? authorCustomResponses.replics : generalReponses;
        message.reply(finalReplics[randint(0, finalReplics.length)]).then(resolve()).catch(reject());
